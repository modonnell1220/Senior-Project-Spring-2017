...
$query2 = "SELECT * FROM Landlord WHERE Email = '$emailID'";  //get all of users code
...
<div class="container-fluid">
    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <form action='../User/editProfile.php' method='post'>
            ...
            <div class="form-group">
                <label class="control-label">Company Name or Personal Name: </label>
                <input type="text" name = "cname" value="<?php echo $cname;?>" maxlength="100" required>
            </div>
            <div class="form-group">
                <label class="control-label">Keys Furnished: </label>
                <input type="number" name = "keys" value="<?php echo $keys;?>" maxlength="5" required>
            </div>
            <div class="form-group">
                <label class="control-label">Replacement Key Fee: </label>
                <input type="number" name = "repKey" value="<?php echo $repKey;?>" maxlength="5" step=".01" required>
            </div>
            <div class="form-group">
                <label class="control-label">Late Fee: </label>
                <input type="number" name = "lateFee" value="<?php echo $lateFee;?>" maxlength="5" step=".01" required>
            </div>
            <div class="form-group">
                <label class="control-label">Check Fee: </label>
                <input type="number" name = "checkFee" value="<?php echo $checkFee;?>" maxlength="5" step=".01" required>
            </div>
            <div class="form-group">
                <label class="control-label">Days before late fee charged: </label>
                <input type="number" name = "lateDays" value="<?php echo $lateDays;?>" maxlength="2" required>
            </div>
            <div>
